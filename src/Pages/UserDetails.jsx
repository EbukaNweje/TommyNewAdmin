...
const UserDetails = () => {
    ...
    const handleGetOneUserData = () => {
        const url = `https://unixswap-coin-api.vercel.app/api/userdata/${id}`;
        axios
            .get(url)
            .then((res) => {
    ...
    const AddProfit = () => {
        const url = `https://unixswap-coin-api.vercel.app/api/add-profit/${id}`;
    ...
    const handleSendEmail = () => {
        setSendEmail(false);
        const toastLoadingId = toast.loading("Please wait...");
            const url = `https://unixswap-coin.onrender.com/api/adminsendemail/${id}`;
            axios
                .post(url, emaildatas)
                .then((response) => {
                    console.log(response);
    ...
    const handleLogin = () => {
        ...
        setTimeout(() => {
            ...
            window.location.href = `https://auth-user-account.vercel.app/#/dashboard/${userId}`;
        }, 3000);
        setShowActions(false);
